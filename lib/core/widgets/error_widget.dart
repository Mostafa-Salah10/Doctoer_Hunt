...
class MyErrorWidget extends StatelessWidget {
  ...
  double _spacing(BuildContext context) {
    return _isTablet(context) ? 24.0 : 16.0;
  }

  double _horizontalPadding(BuildContext context) {
    return _isTablet(context) ? 64.0 : 32.0;
  }

  double _buttonWidth(BuildContext context) {
    return _isTablet(context) ? 240.0 : 200.0;
  }

  double _buttonHeight(BuildContext context) {
    return _isTablet(context) ? 54.0 : 48.0;
  }
...
class _DoubleGearIcon extends StatelessWidget {
  ...
  double _bigGear(BuildContext context) {
    return _isTablet(context) ? 110.0 : 85.0;
  }

  double _smallGear(BuildContext context) {
    return _isTablet(context) ? 65.0 : 50.0;
  }
